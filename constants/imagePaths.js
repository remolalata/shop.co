...
export const FILTER_ICON = "/images/icons/filter-icon.svg";
export const CARET_RIGHT_ICON = "/images/icons/caret-right-icon.svg";
export const CARET_UP_ICON = "/images/icons/caret-up-icon.svg";
export const CARET_DOWN_ICON = "/images/icons/caret-down-icon.svg";
export const WHITE_CHECK_ICON = "/images/icons/white-check-icon.svg";